				...
				<>
					<ul className="space-y-4">
						{cart?.plantedTrees.map((item) => (
							<li
								...
								className="flex items-center justify-between p-4 bg-white border-t border-gray-200 first:border-none"
							>
								<div className="flex items-center gap-4">
									<img
										src={item.catalogTree.image}
										alt={item.catalogTree.commonName}
										className="w-16 h-16 object-cover rounded"
									/>
									<div>
										<strong className="font-semibold text-xl">
											{item.catalogTree.commonName}
										</strong>
								...
								<button
									type="button"
									onClick={() => deleteFromCart(item.plantedTreeId)}
					...
					<div className="mt-8 text-right">
						...
						<button
							...
							className="btn-dark mt-4 px-8 py-3"
						>
