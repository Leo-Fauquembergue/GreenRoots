...
const Checkout: React.FC = () => {
  ...
  const handlePayment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || "Le paiement a échoué. Veuillez réessayer.";
          ...
          <div className="payment-form">
            ...
            <form onSubmit={handlePayment}>
              ...
              <div className="input-group">
                ...
                <input id="cardName" type="text" placeholder="Alex Foret" value={cardName} onChange={(e) => setCardName(e.target.value)} required />
              </div>
              <div className="input-group">
