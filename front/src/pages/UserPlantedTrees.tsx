...
export default function UserPlantedTreesPage() {
  ...
  if (loading) {
    return <p className="min-h-screen text-center pt-10">Chargement de vos arbres...</p>;
  }

  if (error) {
    return <p className="min-h-screen text-center pt-10 text-red-600">Erreur : {error}</p>;
  }
