        ...
        <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full p-8 text-gray-900 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            <p className="text-lg leading-relaxed">
              Nous utilisons des cookies pour améliorer votre expérience sur notre site web et vous offrir des contenus personnalisés.
              En continuant à utiliser notre site, vous acceptez notre{" "}
              <a href="/privacy-policy" className="underline text-green-600 font-semibold">
