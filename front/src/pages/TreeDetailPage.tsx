    ...
    <div className="catalog min-h-screen bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800">Détails de l'arbre</h1>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 flex flex-col justify-between">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-2">{tree.commonName}</h2>
                <p className="text-md text-gray-500 italic mb-6">{tree.scientificName}</p>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div>
                    <strong className="font-semibold">Taille adulte :</strong> {tree.adultHeight} m
                  </div>
                  <div>
                    <strong className="font-semibold">Catégorie :</strong> {tree.category.name}
                  </div>
                  <div>
                    <strong className="font-semibold">Région :</strong> {tree.region.name}
                  </div>
