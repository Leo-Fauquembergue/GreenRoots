      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-gray-800 mb-4">
              GreenRoots vous permet de parrainer un arbre, de choisir son espèce, sa
              région, et de recevoir des mises à jour régulières sur sa croissance,
              sa santé et son impact écologique.
            </p>
            <p className="text-gray-800">
              En collaborant avec des associations locales, nous garantissons une
              plantation responsable, durable, et 100% traçable.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-gray-800 mb-4">
              Chaque arbre possède une fiche de suivi accessible depuis votre espace
              personnel. Hauteur, photos, conditions de croissance... vous suivez
              l’évolution de votre arbre en temps réel.
            </p>
            <p className="text-gray-800">
        ...
        <div className="mb-20">
          ...
          <p className="text-gray-800 text-center max-w-3xl mx-auto leading-relaxed">
            GreenRoots est une plateforme créée en 2025 par une équipe passionnée par
            la nature, le numérique et l’impact positif. <br /><br />
            Notre mission est simple : rendre la reforestation accessible à tous. 🌳
            Grâce à une technologie de suivi innovante et des partenariats locaux
            solides, nous offrons à chaque utilisateur la possibilité de planter un
            arbre, de lui donner un nom et de suivre son évolution dans le temps.
            <br /><br />
            GreenRoots, c’est bien plus qu’un geste symbolique. C’est une manière
            concrète de participer à la restauration des écosystèmes, de soutenir des
            communautés locales et de transmettre un héritage durable aux générations
            futures.
          </p>
        </div>
