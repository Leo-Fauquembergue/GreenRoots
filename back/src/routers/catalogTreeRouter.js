...
catalogTreeRouter.post(
	"/",
	isAuthenticated,
	isAdmin,
	catalogTreeController.createCatalogTree,
);
catalogTreeRouter.patch(
	"/:id",
	isAuthenticated,
	isAdmin,
	catalogTreeController.updateCatalogTree,
);
catalogTreeRouter.delete(
	"/:id",
	isAuthenticated,
	isAdmin,
	catalogTreeController.deleteCatalogTree,
);
