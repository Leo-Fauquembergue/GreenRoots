...
plantedTreeRouter.delete("/:id", isAuthenticated, isAdmin, plantedTreeController.deletePlantedTree);
...
plantedTreeRouter.get("/:id", isAuthenticated, plantedTreeController.getOnePlantedTree);
plantedTreeRouter.patch("/:id", isAuthenticated, plantedTreeController.updatePlantedTree);